...
// Props
interface IDisconnectStravaProps {
...
class DisconnectStrava extends Component<IDisconnectStravaProps> {
...
export default connect(mapStateToProps, { disconnectStrava })(DisconnectStrava);