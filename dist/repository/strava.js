...
module.exports.connectStrava = function connectStrava(res, _id, expiration) {
...
module.exports.refreshAuthenticationToken = function refreshAuthenticationToken(res, _id, expiration) {
    return __awaiter(this, void 0, void 0, function* () {
        let response;
        try {
