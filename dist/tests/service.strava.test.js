...
describe('Strava service tests', () => {
    test("Test connectStrava", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test("Test refreshAuthenticationToken", () => __awaiter(void 0, void 0, void 0, function* () {
        let mock = new axios_mock_adapter_1.default(axios_1.default);
        let mockResponse = {
            data: {
                refresh_token: 'bxkl0y3svkmf3w2sk696m7z65gbu840w288bxtcm',
    ...
    test("Test disconnectStrava", () => __awaiter(void 0, void 0, void 0, function* () {
